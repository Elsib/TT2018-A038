...
\author{M. Bernabé, C. Granados, N. Vega y R. Ortega\\
...
\begin{abstract}
El trabajo terminal presentado consiste en el desarrollo de un sistema embebido que permite el monitoreo remoto de la frecuencia cardíaca y temperatura corporal de una persona. El cálculo de la frecuencia cardíaca se realiza basado en técnicas de procesamiento digital de señales, logrando el cálculo de ésta con una eficiencia superior al 98\%.
\end{abstract}
