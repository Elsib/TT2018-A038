...
Se decidió seleccionar el sensor \textbf{MAX30205} debido a que el rango de medición de temperatura es el más cercano al rango de temperatura corporal, que su error es de $\pm0.1^{\circ}$C cuando realiza mediciones entre los 37$^{\circ}$C y los 39$^{\circ}$C y que tiene un bajo costo. \\
