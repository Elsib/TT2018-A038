...
\subsection{Módulo de comunicación 3G/4G}
El módulo de comunicación permitirá el envío de mensajes SMS con la información proporcionada por el microcontrolador. \\
...
Finalmente se realizó una tabla comparativa entre los módulos de la empresa MikroElektronika que corresponden a los requerimientos buscados. \\
...
Por las características que presenta y el soporte que tiene en la red 3G y 4G nacional, se decidió utilizar el módulo \textbf{4G LTE-AT\&T CLICK} con el chip \textbf{LARA-R202} de ublox, mostrado en la figura \ref{fig:AnalisisGSM}.\\
		...
		\begin{figure}[htbp!]
			\centering
			\fbox{\includegraphics[width=0.6\textwidth]{Analisis/imagenes/4g-lte.png}}
			\caption{4G LTE-AT\&T CLICK}
