...
En esta sección se describen los casos de uso referentes al funcionamiento de la aplicación móvil. \bigskip
	...
	%================CASOS DE USO =============
	\cfinput{ModeloComportamiento/AplicacionMovil/cu1/cu}
	\cfinput{ModeloComportamiento/AplicacionMovil/cu2/cu}
	\cfinput{ModeloComportamiento/AplicacionMovil/cu3/cu}
	\cfinput{ModeloComportamiento/AplicacionMovil/cu4/cu}
	\cfinput{ModeloComportamiento/AplicacionMovil/cu5/cu}
	\cfinput{ModeloComportamiento/AplicacionMovil/cu6/cu}
%	\cfinput{ModeloComportamiento/AplicacionMovil/cu7/cu}

%%===========================================================
%\pagebreak
%\section{Casos de uso del módulo Sistema Embebido}
%En esta sección se describen los casos de uso referentes al funcionamiento del sistema embebido. \bigskip
%
%\begin{objetivos}[Elementos de un caso de uso]
%	\item {\bf Resumen:} Descripción textual del caso de uso.
%	\item {\bf Actores:} Lista de los que intervienen en el caso de uso.
...
%%================CASOS DE USO =============
%
%	\cfinput{ModeloComportamiento/SistemaEmbebido/cu9/cu}
