...
En la tabla \ref{disenoEstructura:gastosDepreciacion} se describen tos gastos del equipo que fue utilizado pero que no se realizó una inversión inicial pues ya se contaba con él. Para estos equipos se consideró únicamente el gasto de la depreciación durante los meses de trabajo
...
\begin{table}[htbp]
	\begin{center}
		\begin{tabular}{|p{4cm}|p{3cm}|p{3cm}|p{3cm}|}
			...
			\hline
			\hline
			Sony VAIO Pro SVP132A1CU & && \\
			\hline
			Asus VivoBook S510U & && \\
			\hline
			Smartphone Motorola G3 & &&\\
			\hline
...
Para obtener el monto total de los gastos para el proyecto, se sumaron los gastos mencionados anteriormente, como se muestra en la tabla \ref{disenoEstructura:gastosTotales}, por lo tanto el costo total estimado del proyecto es:  pesos mexicanos.
